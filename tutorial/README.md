...
* 数据库：
    * MongoDB: 
    ...
    mongod --bind_ip 0.0.0.0 --logpath "D:\Program Files\MongoDB\Server\4.2\data\logs\mongo.log" --logappend --dbpath "D:\Program Files\MongoDB\Server\4.2\data\db" --port 27017 --serviceName "MongoDB" --serviceDisplayName "MonoDB" --install
    ```
    * Redis
    * MySQL
    * Navicat
...
**快速安装命令**：```pip install requests selenium beautifulsoup4 pyquery pymysql pymongo redis flask django jupyter```
...
##### 正则表达式符号
![正则表达式符号](https://github.com/LaplaceJack/Python_Spiders/blob/master/images/regex.png?raw=true)
